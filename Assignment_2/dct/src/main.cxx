...
//#define TIMING_MODE //if defined, removes some delay causing features such as writing images for timing
...
//Display the resized image (cannot be run on the PYNQ Board)
#ifndef TIMING_MODE
    #ifndef __arm__
        imshow("Resized Grayscale", gray);
    #else
        imwrite("resized_grayscale.tif", gray);
    #endif
#endif
